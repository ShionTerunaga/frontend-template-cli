...
var w = 10, N = (e = 0) => (u) => `\x1B[${u + e}m`, I = (e = 0) => (u) => `\x1B[${38 + e};5;${u}m`, R = (e = 0) => (u, t, F) => `\x1B[${38 + e};2;${u};${t};${F}m`, r = {
	modifier: {
		reset: [0, 0],
		bold: [1, 22],
		dim: [2, 22],
...
var iD = Object.keys(r.color), CD = Object.keys(r.bgColor);
[...iD, ...CD];
function rD() {
...
var ED = rD(), d$1 = /* @__PURE__ */ new Set(["\x1B", ""]), oD = 39, y$1 = "\x07", V$1 = "[", nD = "]", G$1 = "m", _$1 = `${nD}8;;`, z = (e) => `${d$1.values().next().value}${V$1}${e}${G$1}`, K$1 = (e) => `${d$1.values().next().value}${_$1}${e}${y$1}`, aD = (e) => e.split(" ").map((u) => p(u)), k$1 = (e, u, t) => {
	const F = [...u];
...
var gD = Object.defineProperty, vD = (e, u, t) => u in e ? gD(e, u, {
	...
	writable: !0,
	value: t
}) : e[u] = t, h = (e, u, t) => (vD(e, typeof u != "symbol" ? u + "" : u, t), t), x$1 = class {
	constructor(u, t = !0) {
...
}, OD = Object.defineProperty, PD = (e, u, t) => u in e ? OD(e, u, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: t
...
var V = ce(), u = (t, n) => V ? t : n, le = u("◆", "*"), L = u("■", "x"), W = u("▲", "x"), C = u("◇", "o"), o = u("│", "|"), d = u("└", "—"), k = u("●", ">"), P = u("○", " "), q = u("●", "•"), D = u("◆", "*"), U = u("▲", "!"), K = u("■", "x"), b = (t) => {
	switch (t) {
		case "initial":
...
}, J = `${import_picocolors_browser.default.gray(o)}  `, x = {
	message: async (t, { symbol: n = import_picocolors_browser.default.gray(o) } = {}) => {
		process.stdout.write(`${import_picocolors_browser.default.gray(o)}
${n}  `);
		let r = 3;
...
`);
	...
	info: (t) => x.message(t, { symbol: import_picocolors_browser.default.blue(q) }),
	success: (t) => x.message(t, { symbol: import_picocolors_browser.default.green(D) }),
	step: (t) => x.message(t, { symbol: import_picocolors_browser.default.green(C) }),
	warn: (t) => x.message(t, { symbol: import_picocolors_browser.default.yellow(U) }),
	warning: (t) => x.warn(t),
	error: (t) => x.message(t, { symbol: import_picocolors_browser.default.red(K) })
};
//#endregion
...
async function techStackCommand(optionTech) {
	if (isSome(optionTech) && isTechStack(optionTech.value)) return createOk(optionTech.value);
	const response = await checkPromiseReturn({
		fn: async () => await ve({
	...
	return createErr(/* @__PURE__ */ new Error("Tech stack selection is invalid"));
}
//#endregion
...
async function vueFrameworkCommand(optionVueFramework) {
	if (isSome(optionVueFramework) && isVueFramework(optionVueFramework.value)) return createOk(optionVueFramework.value);
	const response = await checkPromiseReturn({
		fn: async () => await ve({
...
async function frameworkCommand(optionFramework) {
	if (isSome(optionFramework) && isReactFramework(optionFramework.value)) return createOk(optionFramework.value);
	const response = await checkPromiseReturn({
		fn: async () => await ve({
			message: `Select a framework for your project:`,
			options: [
...
async function reactCli() {
	...
	if (isErr(frameworResult)) return frameworResult;
