...
/******/ (() => {
    ...
    /******/ var __webpack_modules__ = {
        ...
        /***/ 3095: /***/ (
            ...
            const picomatch = __nccwpck_require__(3904);
        ...
        /***/ 6975: /***/ (
            ...
            const constants = __nccwpck_require__(7393);
            const utils = __nccwpck_require__(9173);
        ...
        /***/ 3626: /***/ (
            ...
            const path = __nccwpck_require__(6928);
            const scan = __nccwpck_require__(6099);
            const parse = __nccwpck_require__(6975);
            const utils = __nccwpck_require__(9173);
            const constants = __nccwpck_require__(7393);
            const isObject = (val) =>
...
Filtered results for: ${this.inputValue ? this.inputValue : color.gray("Enter something to filter")}\n`;
        ...
        /***/ 4865: /***/ function (
            ...
            function nameCommand(optionName) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const { createOk, checkPromiseReturn } =
                            ...
                            __awaiter(this, void 0, void 0, function* () {
                                return yield (0, prompts_1.default)({
                                    ...
                                    validate: (name) => {
                                        var _a;
                                        const validation = (0,
                                        validate_npm_name_1.validateNpmName)(
                                            name
                                        );
                                        if (validation.valid) {
                                            return true;
        ...
        /***/ 2119: /***/ function (
            ...
            function techStackCommand(optionTech) {
                return __awaiter(this, void 0, void 0, function* () {
                        ...
                        fn: () =>
                            __awaiter(this, void 0, void 0, function* () {
                                return yield (0, prompts_1.default)({
                                    ...
                                    name: "techStack",
                                    message:
                                        "Select a tech stack for your project:",
                    ...
                    return createNg(
                        new Error("Tech stack selection is invalid")
                    );
                });
            }
        ...
        /***/ 1275: /***/ function (
            ...
            function cssCommand(_a) {
                return __awaiter(
                    ...
                    arguments,
                    void 0,
                    function* ({ optionCss, isCss, csses }) {
                        const { optionConversion } = option_1.optionUtility;
                        const { createOk, createNg, checkPromiseReturn } =
                            result_1.resultUtility;
                        const { onPromptState } = command_core_1.commanderCore;
                            ...
                            fn: () =>
                                __awaiter(this, void 0, void 0, function* () {
                                    return yield (0, prompts_1.default)({
                                        ...
                                        name: "css",
                                        message:
                                            "Select a CSS framework for your project:",
                                        choices: csses,
                                        initial: 0
                                    });
                                }),
        ...
        /***/ 4774: /***/ function (
            ...
            function frameworkCommand(optionFramework) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    return createNg(
                        new Error("Framework selection is invalid")
                    );
                });
            }
                    ...
                    function* (
                        ...
                        for (const p of sourceFiles.value) {
                            ...
                            const baseName = rename(
                                (0, node_path_1.basename)(p)
                            );
                            const from = cwd
                                ? (0, node_path_1.resolve)(cwd, p)
                                : p;
                            const to = parents
                                ? (0, node_path_1.join)(
                                      destRelativeToCwd,
                            ...
                            yield (0, promises_1.mkdir)(
                                (0, node_path_1.dirname)(to),
                                { recursive: true }
                            );
        ...
        /***/ 7253: /***/ function (
            ...
            function validateNpmName(name) {
                ...
                return {
                    valid: false,
                    problems: [
                        ...((_a = nameValidation.errors) !== null &&
                        _a !== void 0
                            ? _a
                            : []),
                        ...((_b = nameValidation.warnings) !== null &&
                        _b !== void 0
                            ? _b
                            : [])
                    ]
        ...
        /***/ 597: /***/ function (
            ...
            function run() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const projectName = yield (0, project_name_1.nameCommand)(
                        optionName
                    );
                    ...
                    const techStack = yield (0, tech_stack_1.techStackCommand)(
                        optionTechStack
                    );
                    if (techStack.isErr) {
        ...
        /***/ 2781: /***/ function (
            ...
            function typescriptTemplateInstall(_a) {
                return __awaiter(
                    ...
                    arguments,
                    void 0,
                    function* ({ root, appName, material }) {
                        ...
                        if (
                            !(0, is_folder_empty_1.isFolderEmpty)(root, appName)
                        ) {
                            return createNg(
                                new Error(
                        ...
                        const raw = yield promises_1.default.readFile(
                            pkgPath,
                            "utf8"
                        );
                        ...
                        const writeResult = yield checkPromiseVoid({
                            ...
                            err: () =>
                                new Error(`Failed to update package.json name`)
                        });
        ...
        /***/ 9645: /***/ (__unused_webpack_module, exports) => {
            "use strict";
        ...
        /***/ 6382: /***/ function (
            ...
            function createApp(_a) {
                return __awaiter(
                    ...
                    arguments,
                    void 0,
                    function* ({ appPath, tech }) {
                        switch (tech) {
                            case "react": {
                                const materialResult = yield (0,
                                react_setting_1.reactCli)();
                                if (materialResult.isErr) {
                                    return materialResult;
                                }
                                return yield (0,
                                react_installer_1.reactInstaller)({
                                    appPath,
                ...
                return __awaiter(
                    ...
                    function* ({ appPath, material }) {
                        ...
                        if (styleSheet.isNone) {
                            return createNg(
                                new Error("CSS option is required")
                            );
                        }
                        return yield (0,
        ...
        /***/ 7005: /***/ (__unused_webpack_module, exports) => {
            "use strict";
        ...
        /***/ 9955: /***/ (__unused_webpack_module, exports) => {
            "use strict";
        ...
        /***/ 9439: /***/ function (__unused_webpack_module, exports) {
            "use strict";
            ...
            exports.resultUtility = (function () {
                ...
                const checkPromiseReturn = (_a) =>
                    __awaiter(this, [_a], void 0, function* ({ fn, err }) {
                        try {
...
Expecting one of '${allowedValues.join("', '")}'`);
        ...
        /***/ 7764: /***/ (__unused_webpack_module, exports) => {
            /**
...
- unrecognised flag format`);
        ...
        /***/ 9087: /***/ (__unused_webpack_module, exports) => {
            const maxDistance = 3;
